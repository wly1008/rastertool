...
out_ph1 = r'D:/app/anaconda3/envs/py313/Lib/site-packages/rastertool/tast/data/OM/reproject/崇仁县int.tif'
out_ph2 = r'D:/app/anaconda3/envs/py313/Lib/site-packages/rastertool/tast/data/OM/reproject/崇仁县2.tif'


rastertool.reproject(ph_tif, crs=4326, out_path=out_ph1, nodata=1)



# rastertool.reproject(out_ph1, crs=4326, out_path=out_ph2, nodata=np.nan)
